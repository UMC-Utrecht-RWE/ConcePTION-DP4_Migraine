...
PERSONS[,impute:=0]
PERSONS[!is.na(year_of_birth) & is.na(day_of_birth) & is.na(month_of_birth),impute:=1]
PERSONS[impute==1, day_of_birth:=1]
PERSONS[impute==1, month_of_birth:=7]
PERSONS[,impute:=NULL]

#impute day and month:death
impt_dm_death<-PERSONS[!is.na(year_of_death) & is.na(day_of_death) & is.na(month_of_death),.N]
PERSONS[,impute:=0]
PERSONS[!is.na(year_of_death) & is.na(day_of_death) & is.na(month_of_death),impute:=1]
PERSONS[impute==1, day_of_death:=1]
PERSONS[impute==1, month_of_death:=7]
PERSONS[,impute:=NULL]
