...
### 1.3 Baseline Migraine Severity Algorithm by year of start pregnancy
...
```{r , echo=F}
if("Step_04_MIG_S1_a_year_age.csv" %in% list.files(paste0(projectFolder,"/g_output/Migraine algorithm/"))){
alg_1<-fread(paste0(projectFolder,"/g_output/Migraine algorithm/Step_04_MIG_S1_a_year_age.csv"))
}else{alg_1<-NULL}

if("Step_04_MIG_S2_a_year_age.csv" %in% list.files(paste0(projectFolder,"/g_output/Migraine algorithm/"))){
alg_2<-fread(paste0(projectFolder,"/g_output/Migraine algorithm/Step_04_MIG_S2_a_year_age.csv"))
}else{alg_2<-NULL}

if("Step_04_MIG_S3_a_year_age.csv" %in% list.files(paste0(projectFolder,"/g_output/Migraine algorithm/"))){
alg_3<-fread(paste0(projectFolder,"/g_output/Migraine algorithm/Step_04_MIG_S3_a_year_age.csv"))
}else{alg_3<-NULL}


if("Step_04_MIG_S1_b_year_age.csv" %in% list.files(paste0(projectFolder,"/g_output/Migraine algorithm/"))){
alg_4<-fread(paste0(projectFolder,"/g_output/Migraine algorithm/Step_04_MIG_S1_b_year_age.csv"))
}else{alg_4<-NULL}

if("Step_04_MIG_S2_b_year_age.csv" %in% list.files(paste0(projectFolder,"/g_output/Migraine algorithm/"))){
alg_5<-fread(paste0(projectFolder,"/g_output/Migraine algorithm/Step_04_MIG_S2_b_year_age.csv"))
}else{alg_5<-NULL}

if("Step_04_MIG_S3_b_year_age.csv" %in% list.files(paste0(projectFolder,"/g_output/Migraine algorithm/"))){
alg_6<-fread(paste0(projectFolder,"/g_output/Migraine algorithm/Step_04_MIG_S3_b_year_age.csv"))
}else{alg_6<-NULL}
...
for(i in 1:length(years)){
   fig.1[[i]]<-ggplotly(ggplot(alg[year_group==years[i]], aes(x=maternal_age,y=prevalence_100_pregnancies, group=algorithm)) +
    ...
    theme(axis.text.x = element_text(size = 8,angle = 45),
          ...
          axis.title.y = element_text(colour = "#76b82a"),
          plot.title = element_text(colour = "#76b82a"))+
    ggtitle(paste0("Baseline migraine severity prevalence rates: ", years[i]))+
    xlab("Maternal age") +
    ylab("Prevalence_per_100_pregnancies")+
...
```{r , echo=F}
if("Step_04_MIG_S1_during_year_age.csv" %in% list.files(paste0(projectFolder,"/g_output/Migraine algorithm/"))){
alg_1<-fread(paste0(projectFolder,"/g_output/Migraine algorithm/Step_04_MIG_S1_during_year_age.csv"))
}else{alg_1<-NULL}

if("Step_04_MIG_S2_during_year_age.csv" %in% list.files(paste0(projectFolder,"/g_output/Migraine algorithm/"))){
alg_2<-fread(paste0(projectFolder,"/g_output/Migraine algorithm/Step_04_MIG_S2_during_year_age.csv"))
}else{alg_2<-NULL}

if("Step_04_MIG_S3_during_year_age.csv" %in% list.files(paste0(projectFolder,"/g_output/Migraine algorithm/"))){
alg_3<-fread(paste0(projectFolder,"/g_output/Migraine algorithm/Step_04_MIG_S3_during_year_age.csv"))
}else{alg_3<-NULL}

if("Step_04_MIG_S4_during_year_age.csv" %in% list.files(paste0(projectFolder,"/g_output/Migraine algorithm/"))){
alg_4<-fread(paste0(projectFolder,"/g_output/Migraine algorithm/Step_04_MIG_S4_during_year_age.csv"))
}else{alg_4<-NULL}
...
### 4.2 Baseline a: Migraine Severity Algorithm in pregnancies diagnosed with migraine in baseline a by year
```{r, echo=F}
if(!is.null(alg_4)){
...
### 4.4 Baseline b: Migraine Severity Algorithm in pregnancies diagnosed with migraine in baseline b by year
```{r, echo=F}
if(!is.null(alg_5)){
...
### 4.6 During pregnancy: Migraine Severity Algorithm in pregnancies diagnosed with migraine during pregnancy by year
```{r, echo=F}
if(!is.null(alg_6)){
