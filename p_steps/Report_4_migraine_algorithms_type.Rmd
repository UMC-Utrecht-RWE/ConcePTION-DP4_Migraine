...
## 1. Creation of the Migraine Type Algorithms: Baseline
...
### 1.1 Baseline Migraine Type Algorithm Overall
...
alg1[no_diagnosed_pregnancies>0 & prevalence_100_pregnancies==0, prevalence_100_pregnancies:=0.0001]
alg2<-rbind(alg_7,alg_8,alg_9,alg_10,alg_11,alg_12)
alg2[no_diagnosed_pregnancies>0 & prevalence_100_pregnancies==0, prevalence_100_pregnancies:=0.0001]
...
### 1.2 Baseline Migraine Type Algorithm by maternal age at start pregnancy
...
### 1.3 Baseline Migraine Type Algorithm by year of start pregnancy
...
### 1.4 Baseline Migraine Algorithm by maternal age and year of start pregnancy
...
## 2. Creation of the Migraine Type Algorithms: During pregnancy

If the prevalence is rounded to zero but the number of diagnosed pregnancies is higher than zero than the prevalence will be replaced with 0.0001.
<br>

### 2.1 During pregnancy: Migraine Type Algorithm Overall
...
### 2.3 During pregnancy: Migraine Algorithm by year of start pregnancy
...
### 2.4 During pregnancy: Migraine Algorithm by maternal age and year of start pregnancy
...
## 3. Migraine Type Algorithms: Ocurrence prior to pregnancy and during pregnancy
...
## 4. Migraine Type Algorithms: Ocurrence prior to pregnancy and during pregnancy within pregnancies diagnosed with migraine
...
```{r , echo=F}
if("Step_04_MIG_T_a.csv" %in% list.files(paste0(projectFolder,"/g_output/Migraine algorithm/"))){
alg_1<-fread(paste0(projectFolder,"/g_output/Migraine algorithm/Step_04_MIG_T_a.csv"))
}else{alg_1<-NULL}
alg_1[no_diagnosed_pregnancies>0 & percentage==0, percentage:=0.0001]


if("Step_04_MIG_T_b.csv" %in% list.files(paste0(projectFolder,"/g_output/Migraine algorithm/"))){
alg_2<-fread(paste0(projectFolder,"/g_output/Migraine algorithm/Step_04_MIG_T_b.csv"))
}else{alg_2<-NULL}
alg_2[no_diagnosed_pregnancies>0 & percentage==0, percentage:=0.0001]

if("Step_04_MIG_T_during.csv" %in% list.files(paste0(projectFolder,"/g_output/Migraine algorithm/"))){
alg_3<-fread(paste0(projectFolder,"/g_output/Migraine algorithm/Step_04_MIG_T_during.csv"))
}else{alg_3<-NULL}
alg_3[no_diagnosed_pregnancies>0 & percentage==0, percentage:=0.0001]


if("Step_04_MIG_T_a_year.csv" %in% list.files(paste0(projectFolder,"/g_output/Migraine algorithm/"))){
alg_4<-fread(paste0(projectFolder,"/g_output/Migraine algorithm/Step_04_MIG_T_a_year.csv"))
}else{alg_4<-NULL}
alg_4[no_diagnosed_pregnancies>0 & percentage==0, percentage:=0.0001]

if("Step_04_MIG_T_b_year.csv" %in% list.files(paste0(projectFolder,"/g_output/Migraine algorithm/"))){
alg_5<-fread(paste0(projectFolder,"/g_output/Migraine algorithm/Step_04_MIG_T_b_year.csv"))
}else{alg_5<-NULL}
alg_5[no_diagnosed_pregnancies>0 & percentage==0, percentage:=0.0001]

if("Step_04_MIG_T_during_year.csv" %in% list.files(paste0(projectFolder,"/g_output/Migraine algorithm/"))){
alg_6<-fread(paste0(projectFolder,"/g_output/Migraine algorithm/Step_04_MIG_T_during_year.csv"))
}else{alg_6<-NULL}
alg_6[no_diagnosed_pregnancies>0 & percentage==0, percentage:=0.0001]

```

### 4.1 Baseline a: Migraine Type Algorithm in pregnancies diagnosed with migraine in baseline a
```{r, echo=F}
if(!is.null(alg_1)){
...
### 4.2 Baseline a: Migraine Type Algorithm in pregnancies diagnosed with migraine in baseline a by year
```{r, echo=F}
if(!is.null(alg_4)){
...
### 4.3 Baseline b: Migraine Type Algorithm in pregnancies diagnosed with migraine in baseline b
```{r, echo=F}
if(!is.null(alg_2)){
...
### 4.4 Baseline b: Migraine Type Algorithm in pregnancies diagnosed with migraine in baseline b by year
```{r, echo=F}
if(!is.null(alg_5)){
...
### 4.5 During pregnancy: Migraine Type Algorithm in pregnancies diagnosed with migraine during pregnancy
```{r, echo=F}
if(!is.null(alg_3)){
...
### 4.6 During pregnancy: Migraine Type Algorithm in pregnancies diagnosed with migraine during pregnancy by year
```{r, echo=F}
if(!is.null(alg_6)){
...
* MIG_T_a: Proportion of migraine type stratified over the algorithms T1-T6 in pregnancies diagnosed with baseline migraine (365 days/90 days/75 days/).\
* MIG_T_b: Proportion of migraine type stratified over the algorithms T1-T6 in pregnancies diagnosed with baseline migraine (90 days/75 days/).\
* MIG_T_during: Proportion of migraine type stratified over the algorithms T1-T6 in pregnancies diagnosed with migraine during pregnancy.\
