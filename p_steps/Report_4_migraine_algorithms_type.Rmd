...
### 1.3 Baseline Migraine Type Algorithm by year group of start pregnancy
...
### 4.2 Baseline a: Migraine Type Algorithm in pregnancies diagnosed with migraine in baseline a by year group
```{r, echo=F}
if(!is.null(alg_4)){
...
### 4.4 Baseline b: Migraine Type Algorithm in pregnancies diagnosed with migraine in baseline b by year group
```{r, echo=F}
if(!is.null(alg_5)){
...
### 4.6 During pregnancy: Migraine Type Algorithm in pregnancies diagnosed with migraine during pregnancy by year group
```{r, echo=F}
if(!is.null(alg_6)){
