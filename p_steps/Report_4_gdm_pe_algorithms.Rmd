...
`original_records`: Total umber of records after merging the pregnancy D3 with the diagnoses D3\
...
## 2. Creation of the PE Algorithms

<br>

### 2.1 PE Algorithm Overall
...
### 2.2 PE Algorithm by maternal age at start pregnancy
...
### 2.3 PE Algorithm by year of start pregnancy
...
### 2.4 PE Algorithm by maternal age and year of start pregnancy
